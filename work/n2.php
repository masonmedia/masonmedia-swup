<?php 
    $title = "Mason Media | N2 Speech Therapy";
        ...
        <div class="row d-flex min-700-lg relative py-5">
            ...
            <div class="col-lg-5 d-flex flex-column justify-content-center align-items-start text-left text-light p-5">
                ...
                <h2 class="site-title font-weight-bold">
                    <span class="d-block knockout-rainbow">Assessment,</span>
                    <span class="d-block knockout-rainbow">therapy,</span>
                    <span class="d-block knockout-rainbow">strategies,</span>
    ...
    <div class="modal fade" id="modal" tabindex="-1" role="dialog" aria-labelledby="advanceTherapyModal" aria-hidden="true">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="at-modal">N2 Speech Therapy</h5>
