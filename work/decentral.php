...
?>
        ...
        <div class="row d-flex min-700-lg relative py-5">
            ...
            <div class="col-lg-5 d-flex flex-column justify-content-center align-items-start text-left p-5">
                ...
                <h2 class="site-title font-weight-bold knockout-rainbow">
                    <span class="d-block knockout-rainbow">Canada's</span>
                    <span class="d-block knockout-rainbow">leading</span>
                    <span class="d-block knockout-rainbow">blockchain</span>
                    <span class="d-block knockout-rainbow">company.</span>
                </h2>
    ...
    <div class="container-fluid p-0 relative">
        ...
        <section>
            <div class="row d-flex bg-white relative">
                <div class="col-lg-12 min-700-lg p-0 down down-med">                
                    <img class="img-full absolute z-0 left-0 lazy" data-src="/assets/img/jaxx-iphone-here-look.jpg" alt="DJ Mycorrhiza">
                </div>
            </div>
        </section>
        ...
        <section>
            <div class="row d-flex bg-white relative">
                <div class="col-lg-12 min-700-lg p-0 down down-med">
                    <img class="img-full absolute z-0 left-0 lazy" data-src="/assets/img/jaxx-iphone-flying-2-screens.jpg" alt="Andrew Mason Portfolio: Decentral Inc.">
                </div>
            </div>
        </section>
