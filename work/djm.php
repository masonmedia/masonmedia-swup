<?php 
    $title = "Mason Media | DJ Mycorrhiza";
...
?>
    ...
    <div role="banner" class="container-fluid bg-black p-0">
        <div class="row d-flex min-700-lg relative py-5">
            <img class="img-full absolute z-0 left-0 up up-med lazy" data-src="/assets/img/djm-macbook-black.jpg" alt="Andrew Mason Portfolio: DJ Mycorrhiza">
            <div class="col-lg-5 d-flex flex-column justify-content-center align-items-start text-left text-light p-5">
                ...
                <h2 class="site-title font-weight-bold knockout-rainbow">
                    <span class="d-block knockout-rainbow">DJ.</span>
                    <span class="d-block knockout-rainbow">Producer.</span>
                    <span class="d-block knockout-rainbow">Composer.</span>
