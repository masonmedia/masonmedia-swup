        ...
        <div class="row d-flex min-700-lg relative py-5">
            ...
            <div class="col-lg-6 d-flex flex-column justify-content-center align-items-start text-left text-light p-5">
                ...
                <h2 class="site-title font-weight-bold knockout-rainbow">
                    <span class="d-block knockout-rainbow">Funk</span>
                    <span class="d-block knockout-rainbow">Jazz</span>
                    <span class="d-block knockout-rainbow">Brass Band</span>
                ...
                <div class="container-fluid pt-3 pl-0">
                    <div class="row d-flex justify-content-center align-items-center text-center mt-3">
                        ...
                        <div class="col-xs-6 zoom zoom-slow">
                            <a href="/work/copetin.php"><p class="p-btn border-0 p-0">Next project <i class="fa fa-angle-right fa-btn p-0 pl-2"></i></p></a> 
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <a href="http://surefiresweat.com" target="_blank">
                        <h5 class="border-top pt-3 font-weight-bold text-right">surefiresweat.com/</h5>
                    </a>
                </div>
