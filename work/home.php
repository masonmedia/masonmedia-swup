...
?> 
    ...
    <div class="container-fluid p-0 relative">
         ...
         <section>
            <div class="row d-flex bg-light relative">
                <div class="col-lg-12 min-700-lg down down-med">                
                    <img class="img-full absolute z-0 left-0 lazy" data-src="/assets/img/jaxx-macbook-coffee-notebook.jpg" alt="Blockchain software company Decentral Inc.">
                </div>
            </div>
        </section>
        ...
        <section>
            <div class="row d-flex bg-light relative">
                <div class="col-lg-12 min-700-lg down down-med">                
                    <img class="img-full absolute z-0 left-0 lazy" data-src="/assets/img/atherapy-banner.jpg" alt="Healthcare services provider Advance Therapy">
                </div>
            </div>
        </section>
       ...
       <!--surefire-->
        ...
        <section>
            <div class="row d-flex bg-light relative">
                <div class="col-lg-12 min-700-lg down down-med">
                    <img class="img-full absolute left-0 lazy" data-src="/assets/img/mason-media-chips.jpeg" alt="Mason Media">
                </div>
            </div><!--end row-->
        </section>
