    ...
    <div class="container-fluid p-0 relative">
        ...
        <div class="row d-flex p-5 min-500 text-secondary bg-white">
            ...
            <div class="col-lg-6 d-flex flex-column justify-content-center align-items-start text-left o-12">
                <p class="p-big pt-3 m-0">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Omnis quaerat sint totam distinctio iste rerum debitis, vitae porro consectetur molestiae, accusamus id optio. Voluptatum, odit! Tempore facilis, maiores dolores eius.</p>
