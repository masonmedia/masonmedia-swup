        ...
        <div class="row d-flex min-700-lg relative py-5">
            ...
            <div class="col-lg-9 d-flex flex-column justify-content-center align-items-start text-left text-light p-5">
                ...
                <h2 class="site-title font-weight-bold">
                    <span class="d-block knockout-rainbow">Fast.</span>
                    <span class="d-block knockout-rainbow">Funny.</span>
                    <span class="d-block knockout-rainbow">Spelled correctly.</span>
                </h2>
        ...
        <section>
            <div id="sec-1" class="row d-flex p-5 min-500 text-secondary bg-white">
                ...
                <div class="col-lg-8 banner-center py-3">
                    ...
                    <a href="#sec-2"><p class="p-btn mt-3 border-0 p-0">Content <i class="fa fa-angle-right fa-btn"></i></p></a> 
                </div>
                <div class="offset-lg-2"></div>
            </div><!--end row-->  
        </section>
       ...
       <!-- content writing-->
        ...
        <section>
            <div id="sec-2" class="row d-flex min-500 p-5 text-secondary bg-white">
                ...
                <div class="col-lg-8 banner-center py-3">
                    ...
                    <a href="#sec-3"><p class="p-btn mt-3 border-0 p-0">Editing <i class="fa fa-angle-right fa-btn"></i></p></a> 
                </div>
                <div class="offset-lg-2"></div>
            </div>
        </section>
        ...
        <div id="sec-3" class="row d-flex min-500 p-5 text-secondary bg-white">
            ...
            <div class="col-lg-8 banner-center py-3">
                ...
                <a href="#sec-4"><p class="p-btn mt-3 border-0 p-0">SEO <i class="fa fa-angle-right fa-btn"></i></p></a> 
            </div>
            <div class="offset-lg-2"></div>
        </div><!--end row-->
        ...
        <section>
            <div id="sec-4" class="row d-flex min-500 p-5 text-secondary bg-white">
                ...
                <div class="col-lg-8 banner-center py-3">
                    ...
                    <a href="#sec-5"><p class="p-btn mt-3 border-0 p-0">Work <i class="fa fa-angle-right fa-btn"></i></p></a> 
                </div>
                <div class="offset-lg-2"></div>
            </div><!--end row-->
        </section>
