    ...
    <div class="container-fluid p-0 relative">
        ...
        <div class="row d-flex min-500 text-secondary bg-white">
            ...
            <div class="col-lg-8 d-flex flex-column justify-content-center align-items-center text-center p-5">
                ...
                <p class="p-big pt-3 m-0">From corrections to grammar and spelling, to improved style, readability and user experience, I reframe, edit and update existing written content. I strive to make content fast-moving, easy to read, and grammatically correct, with a focus on parsing text for online/web experience.</p>
            </div>
            <div class="offset-lg-2"></div>
        </div><!--end row-->
